...
def upload():
    ...
    if video and allowed_file(video.filename):
        ...
        return render_template('final.html', video_name=video.filename)
...
def cut():
    # Load the video
    video = mp.VideoFileClip("D:\\ht\\.vscode\\project\\static\\videos\\input.mp4")
    ...
    # Find the start and end time of the words in the transcript
